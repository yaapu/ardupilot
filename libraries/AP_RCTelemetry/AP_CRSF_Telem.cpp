...
void AP_CRSF_Telem::process_device_info_frame(ParameterDeviceInfoFrame* info)
{
    ...
    */
    ...
    while (info->payload[offset] != 0x0 && offset++ < 42U);
    /*
...
void AP_CRSF_Telem::calc_status_text()
{
    ...
    strncpy(_telem.bcast.custom_telem.status_text.text, _statustext.next.text, ARRAY_SIZE(_telem.bcast.custom_telem.status_text.text));
