...
private:
    ...
    AP_OSD_Setting flmode   {true, 1, 1};        // OSD_FLYMODE
    AP_OSD_Setting name     {true, 10, 9};       // OSD_CRAFT_NAME
    AP_OSD_Setting curr     {true, 0, 13};       // OSD_CURRENT_DRAW
    AP_OSD_Setting mah      {true, 0, 12};       // OSD_MAH_DRAWN
    ...
    AP_OSD_Setting hdir     {true, 1, 11};       // OSD_HOME_DIR
    AP_OSD_Setting hdist    {true, 2, 11};       // OSD_HOME_DIST
    AP_OSD_Setting vario    {true, 22, 12};      // OSD_NUMERICAL_VARIO
    AP_OSD_Setting arm      {true, 10, 10};      // OSD_DISARMED
    AP_OSD_Setting aspd     {false, 21, 15};     // AIRSPEED, overrides OSD_PITCH_ANGLE
